...
- **Icons**: brand/tech-stack icons are individual SVG files in `src/assets/`. UI icons (e.g. GitHub in `Contact.jsx`) come from a single sprite at `public/icons.svg` via `<use href="/icons.svg#icon-id" />`.
