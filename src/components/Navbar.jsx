...
const linkClass =
  "block rounded-full px-4 py-2 text-[15px] font-medium text-ink transition hover:bg-ink/8 hover:text-purple-deep max-[960px]:w-full max-[960px]:px-4 max-[960px]:py-3 max-[960px]:text-[17px]";
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            ...
            <li className="max-[960px]:w-full">
              <a
                href="#contact"
                className="ml-2 block rounded-full bg-purple px-4 py-2 text-[15px] font-semibold text-ink-contrast shadow-soft transition hover:-translate-y-px hover:bg-purple-deep max-[960px]:ml-0 max-[960px]:mt-2.5 max-[960px]:w-full max-[960px]:py-3 max-[960px]:text-center"
                onClick={close}
              >
                Hire Me
              </a>
